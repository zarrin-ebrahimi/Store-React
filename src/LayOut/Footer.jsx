...
export default function Footer() {
  return (
    <div className="bg-gray-100 py-5 px-3 flex justify-between gap-x-5 ">
      <div>
...
وب سایت مسترمانتو دارای بیش از 7 سال مجوزهای قابل پیگیری ورسمی ،از وزارت صنعت ،معدن وتجارت(اینماد)و...رامیباشد
        </span>
      </div>
